...
router.post("/", img_controller.upload.single("image"), ctrlWrapper(controller.create_product));
// router.get('/:id', ctrlWrapper(controller.get_product_by_id));
router.put('/:id', img_controller.upload.single("image"), ctrlWrapper(controller.update_product));
